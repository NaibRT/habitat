...
import logoLightPng from "../../assets/images/icons/logo.svg";
import logoLightSvg from "../../assets/images/icons/logo-sm.svg";
            ...
            <div className="d-flex">
              ...
              <form className="app-search d-none d-lg-block">
                <div className="position-relative">
                  <input type="text" className="form-control" placeholder={this.props.t('Axtar') + "..."} />
                  ...
                  <form className="p-3">
                    <div className="form-group m-0">
                      <div className="input-group">
                        <input type="text" className="form-control" placeholder="Axtar ..." aria-label="Recipient's username" />
